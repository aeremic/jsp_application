...
<html>
<head>
<title>MobileShop - Mobilni telefoni</title>
<meta charset="utf-8">
...
<body>
    ...
    <div class="container">
            ...
            <nav class="mt-2 navbar sticky-top navbar-expand-lg navbar-dark bg-dark rounded">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                  <div class="navbar-nav">
                    ...
                    <a class="nav-item nav-link active" href="all.jsp">MOBILNI TELEFONI<span class="sr-only">(current)</span></a>
        ...
        <div class="stories shadow-sm p-3 mb-5 bg-white rounded">
            <h1 class="font-weight-light text-center text-lg-left mt-4 mb-0">Svi mobilni telefoni</h1>
            <hr class="mt-2 mb-5">
            <div class="card-deck">
            	<% 
            	...
            	%>
            		<div class="card">
		                ...
		                <div class="card-body">
		                  ...
		                  <a href="details.jsp?id=<%= phone.getId() %>" class="btn btn-primary stretched-link">Saznaj vise</a>
		                </div>
	              	</div>
